...
part of 'customerRequestDTO.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CustomerRequestDTO _$CustomerRequestDTOFromJson(Map<String, dynamic> json) {
  return CustomerRequestDTO()
    ...
    ..items = (json['items'] as List)
        ...
        ?.toList()
    ..supplierListDto = (json['supplierListDto'] as List)
        ?.map((e) => e == null
            ? null
            : SupplierListDto.fromJson(e as Map<String, dynamic>))
        ?.toList()
    ..customerRequestAttributeListDto =
        (json['customerRequestAttributeListDto'] as List)
            ?.map((e) => e == null
                ? null
                : CustomerRequestAttributeListDto.fromJson(
    ...
    ..rejectedRequestCount = json['rejectedRequestCount'] as String
...
Map<String, dynamic> _$CustomerRequestDTOToJson(CustomerRequestDTO instance) =>
    <String, dynamic>{

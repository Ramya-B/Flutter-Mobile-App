...
RequestDetailDto _$RequestDetailDtoFromJson(Map<String, dynamic> json) {
  return RequestDetailDto()
    ...
    ..customerRequestAttributeListDto =
        json['customerRequestAttributeListDto'] as String
    ...
    ..custRequestMessageDTO = (json['custRequestMessageDTO'] as List)
        ?.map((e) => e == null
            ? null
            : CustRequestMessageDTO.fromJson(e as Map<String, dynamic>))
        ?.toList()

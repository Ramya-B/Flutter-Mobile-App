...
class _MyLeadsState extends State<MyLeads> {
  ...
  getLeadsForParty(supplierReceiveCustRequestDTO) async {
    print("getLeadsForParty caled");
    var res = await ormService
        .getSupplierReceiveCustRequest(supplierReceiveCustRequestDTO);
    print("getLeadsForParty response");
    setState(() {
      ...
      if (selectedLeads != null &&
        ...
        for (SupplierResponseListDto lead in selectedLeads) {
          if (lead.requestDto.lobId == "34343e34-7601-40de-878d-01b3bd1f0642" ||
              lead.requestDto.lobId == "34343e34-7601-40de-878d-01b3bd1f0643") {
            lead.requestDto.lobName = "BLISS";
          } else if (lead.requestDto.lobId ==
                  "34343e34-7601-40de-878d-01b3bd1f0641" ||
              lead.requestDto.lobId == "34343e34-7601-40de-878d-01b3bd1f0644") {
                        ...
                        new GestureDetector(
                          onTap: () {
                            Navigator.of(context).push(
                                new MaterialPageRoute(builder: (context) => new LeadsDetailPage(
                                  customerRequestId: selectedLeads[index]
                                      .requestDto
                                      .customerRequestId,
                                )));

...
class _BlissHomePageState extends State<BlissHomePage> {
  ...
  getCategories() async {
    ...
    setState(() {
      ...
      print(data);
      this.categoryList = List<CategoryDTO>.from(data.map((f)=> CategoryDTO.fromJson(f))).toList();
      // var dup = [];
      // for (var cat in data) {
            ...
            Container(
              ...
              decoration: new BoxDecoration(
                image: new DecorationImage(
                  image: new AssetImage('assets/venkat/sea.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
              child: Container(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  itemCount: this.categoryList.length,
                    ...
                    children: <Widget>[
                      ListView.builder(
                         shrinkWrap: true,
                        physics: const NeverScrollableScrollPhysics(),
                         itemCount: this.categoryList[index].categoryAttribute.length >9 
                         ? 9 : this.categoryList[index].categoryAttribute.length,
                        itemBuilder: ( context,int index1){
                        return (this.categoryList[index].categoryAttribute[index1].attributeName == 'ThumbnailImageAttribute') ?
                        Center(
                                                  child: Container(
                            width: 120.0,
                            height: 120.0,
                  ...
                  SizedBox(
                    ...
                    child:
                        Image.asset("assets/tllogo.png", fit: BoxFit.contain),
                  ),
                  Container(
                      padding: EdgeInsets.all(20),
                      child: Column(
